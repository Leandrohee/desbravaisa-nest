...
export namespace Prisma {
  ...
  */
  ...
  export interface UserDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * 
     * // Only select the `cod_user`
     * const userWithCod_userOnly = await prisma.user.findMany({ select: { cod_user: true } })
     * 
     */
     ...
     * })
     * 
     * // Create many Users and only return the `cod_user`
     * const userWithCod_userOnly = await prisma.user.createManyAndReturn({
     *   select: { cod_user: true },
     *   data: [
     *     // ... provide data here
     *   ]
     * })
     ...
     * })
     * 
     * // Update zero or more Users and only return the `cod_user`
     * const userWithCod_userOnly = await prisma.user.updateManyAndReturn({
     *   select: { cod_user: true },
     *   where: {
     *     // ... provide filter here
     *   },
  ...
  interface UserFieldRefs {
    readonly cod_user: FieldRef<"User", 'Int'>
  ...
  export type UserWhereInput = {
    ...
    cod_user?: IntFilter<"User"> | number
  ...
  export type UserScalarWhereWithAggregatesInput = {
    ...
    cod_user?: IntWithAggregatesFilter<"User"> | number
